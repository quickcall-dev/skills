...
FLEET_ROOT="/home/sagar/skills/docs/experiments/001-dummy-demo-test/autoresearch-fleet"
FLEET_JSON="/home/sagar/skills/docs/experiments/001-dummy-demo-test/autoresearch-fleet/fleet.json"
FLEET_NAME="autoresearch-demo"
WORKDIR="/home/sagar/skills/docs/experiments/001-dummy-demo-test/autoresearch-fleet/workdir"
RESULTS_FILE="/home/sagar/skills/docs/experiments/001-dummy-demo-test/autoresearch-fleet/workdir/results.tsv"
EVAL_CMD="python3 eval.py"
PROGRAM_MD="program.md"
PROGRAM_MD_PATH="/home/sagar/skills/docs/experiments/001-dummy-demo-test/autoresearch-fleet/program.md"
METRIC_DIR="maximize"
METRIC_REGEX="^score:\s*([0-9.]+)"
MAX_ITERATIONS=5
COST_CAP=2
BUDGET_PER_ITER=0.25
MAX_TURNS=0
PLATEAU_THRESHOLD=3
SEARCH_ENABLED=true
MODEL="haiku"
...
PROVIDER="claude"
TMUX_SESSION="autoresearch-demo"
LIB_DIR="/home/sagar/skills/skills/autoresearch-fleet/scripts/../lib"
POLL_INTERVAL=5
